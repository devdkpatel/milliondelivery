...
function load_javascript() {
    wp_register_script( 'jQuery', get_template_directory_uri() . '/assets/js/script.js', array(), filemtime( get_template_directory() . '/assets/js/script.js' ), true );
...
register_nav_menus(
    array(
        ...
        'privacy-menu' => __( 'Privacy Links', 'theme' ),
    )
);
